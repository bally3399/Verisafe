            ...
            <Card className="bg-slate-800/50 border-slate-700">
              <CardHeader className="text-center">
                ...
                <CardDescription className="text-slate-400">
                  Your credentials have been securely shared on the Cardano blockchain
                </CardDescription>
              </CardHeader>
              ...
              {credentials.length === 0 ? (
                <Card className="bg-slate-800/50 border-slate-700">
                  <CardContent className="text-center py-12">
                    ...
                    <p className="text-slate-400 mb-6">You need to create credentials before you can share them.</p>
                    <Button
                      onClick={onBack}
                          ...
                          <CardHeader className="pb-3">
                            <div className="flex items-center justify-between">
                              ...
                              <Badge
                                ...
                                className={
                                  cred.status === "active" ? "bg-green-900/30 text-green-400 border-green-500/30" : ""
                                }
                              >
                                {cred.status}
                              </Badge>
                          ...
                          {selectedCredentials.includes(cred.id) && (
                            <CardContent className="pt-0">
                              <div className="bg-slate-800/50 p-4 rounded-lg">
                                  ...
                                  {Object.entries(cred.fields).map(([field, value]) => (
                                    ...
                                    >
                                      ...
                                      <div className="flex-1 min-w-0">
                                        <Label className="text-slate-300 text-sm font-medium capitalize cursor-pointer">
                                ...
                                <div className="mt-4 p-3 bg-sky-900/20 rounded-lg border border-sky-500/30">
                                  <p className="text-sky-300 text-xs flex items-center">
                                    <Shield className="h-3 w-3 mr-1" />
                                    Only selected fields will be shared. Recipients cannot access other data.
                                  </p>
                                </div>
                              </div>
                            </CardContent>
                      ...
                      <CardContent className="space-y-4">
                        <div>
                          ...
                          <Input
                            ...
                            placeholder="addr1qx2fxv2umyhttkxyxp8x0dlpdt3k6cwng5pxj3jhsydzer3jcu5d8ps7zex2k2xt6ll2qzqz..."
                          />
                        </div>
                        <Button
                          onClick={handleShare}
