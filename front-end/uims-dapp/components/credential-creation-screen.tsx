...
import { ArrowLeft, Plus, CheckCircle, AlertTriangle, Loader2, Copy, ExternalLink, Wallet } from "lucide-react"
  ...
  const handleCreateCredential = () => {
    ...
    setTimeout(() => {
      ...
      if (success) {
        ...
        onComplete(newCred) // Pass the new credential back to the dashboard
      }
      setIsCreating(false)
    }, 3000)
  }
                ...
                <div>
                  ...
                  <Select value={credentialType} onValueChange={setCredentialType}>
                    ...
                    <SelectContent className="bg-slate-800 border-slate-600">
                      <SelectItem value="Identity Verification" className="text-slate-200 hover:bg-slate-700">
                        Identity Verification
                      </SelectItem>
                      <SelectItem value="Educational Certificate" className="text-slate-200 hover:bg-slate-700">
                        Educational Certificate
                      </SelectItem>
                      <SelectItem value="Professional License" className="text-slate-200 hover:bg-slate-700">
                        Professional License
                      </SelectItem>
                      <SelectItem value="Custom Credential" className="text-slate-200 hover:bg-slate-700">
                        Custom Credential
                      </SelectItem>
                    </SelectContent>
                  </Select>
                  ...
                  {customFields.map((field, index) => (
                    <div key={index} className="flex items-end space-x-2">
                      ...
                      <Button
                        ...
                        className="shrink-0"
                      >
                        <Plus className="h-4 w-4 rotate-45" /> {/* Using Plus and rotating for an X icon */}
                      </Button>
                    </div>
                  ))}
                </div>
